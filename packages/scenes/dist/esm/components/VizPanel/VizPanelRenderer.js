...
function VizPanelRenderer({ model }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: relativeWrapper + " oodle-panel" }, /* @__PURE__ */ React.createElement("div", { ref, className: absoluteWrapper, "data-viz-panel-key": model.state.key }, width > 0 && height > 0 && // @ts-expect-error showMenuAlways remove when updating to @grafana/ui@12 fixed in https://github.com/grafana/grafana/pull/103553
  /* @__PURE__ */ React.createElement(
    PanelChrome,
    {
